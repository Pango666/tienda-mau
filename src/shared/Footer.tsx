  ...
  return (
    <footer className="w-full bg-surface-container-lowest border-t border-outline-variant/30">
      <div className="w-full max-w-[1440px] mx-auto px-4 md:px-margin-tablet lg:px-margin-desktop py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 pb-12 border-b border-outline-variant/20">
          {/* Brand */}
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-2 font-label-mono text-body-sm text-on-surface-variant">
              <li><Link to="/" className="hover:text-on-surface cursor-pointer">ARCHIVO FW25</Link></li>
              ...
              <li className="hover:text-on-surface cursor-pointer">MANIFIESTO DE MARCA</li>
            </ul>
          </div>
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-2 font-label-mono text-body-sm text-on-surface-variant">
              <li className="hover:text-on-surface cursor-pointer">ESTADO DEL ENVÍO</li>
              <li className="hover:text-on-surface cursor-pointer">GUÍA DE TALLES</li>
              <li className="hover:text-on-surface cursor-pointer">POLÍTICA DE DEVOLUCIÓN</li>
          ...
          <div className="md:col-span-1">
            ...
            <p className="font-body-sm text-body-sm text-on-surface-variant mb-3">
              Acceso anticipado a drops de edición limitada.
            </p>
            <div className="flex">
              <input
                className="bg-surface-container font-label-mono text-body-sm px-3 py-2 text-on-surface border border-outline-variant/40 focus:outline-none focus:border-primary-container flex-1"
                placeholder="TU_CORREO@OVERKAP.COM"
                type="email"
              />
              <button
                className="bg-primary-container text-on-primary-container font-label-mono text-label-mono px-4 py-2 uppercase hover:bg-surface-bright hover:text-on-surface transition-colors"
                type="button"
              >
                UNIRSE
              </button>
        ...
        <div className="pt-8 flex flex-col md:flex-row items-center justify-between gap-4 font-label-mono text-[11px] text-outline">
          ...
          <div className="flex items-center gap-6">
            ...
            <a className="hover:text-on-surface transition-colors uppercase" href="#">DISCORD</a>
            <a className="hover:text-on-surface transition-colors uppercase" href="#">TERMINOS Y PRIVACIDAD</a>
          </div>
        </div>
      </div>
    </footer>
